    ...
    sections: [
      {
        ...
        content: [
          { id: 'w1', kind: 'text', text: 'This short workbook is a working sample — every box below is fillable, so go ahead and type and check right inside the PDF. Use it to feel how an interactive workbook works for your own learners.' },
