...
// WITHOUT a session.
export const config = {
  matcher: ['/((?!login|register|verify|try|api/login|api/register|api/logout|api/inquiry|api/track-try|api/track-session|api/stripe/webhook|_next/static|_next/image|favicon.ico|.*\\..*).*)'],
};
